...
public class QianshouxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,QianshouxinxiEntity qianshouxinxi, 
		...
		if(tableName.equals("yonghu")) {
			qianshouxinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("shangjia")) {
			qianshouxinxi.setShangjiazhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R save(@RequestBody QianshouxinxiEntity qianshouxinxi, HttpServletRequest request){
    	qianshouxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R add(@RequestBody QianshouxinxiEntity qianshouxinxi, HttpServletRequest request){
    	qianshouxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(qianshouxinxi);
    	qianshouxinxi.setUserid((Long)request.getSession().getAttribute("userId"));
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<QianshouxinxiEntity> wrapper = new EntityWrapper<QianshouxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = qianshouxinxiService.selectCount(wrapper);
