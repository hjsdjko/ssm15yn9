<template>
	<view class="content">
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.lianxifangshi" type="text" class="uni-input" name="" placeholder="联系方式" />
		</view>
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shangjiazhanghao" type="text" class="uni-input" name="" placeholder="商家账号" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mima" type="text" class="uni-input" name="" placeholder="密码" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(121, 186, 121, 1)","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shangjiaxingming" type="text" class="uni-input" name="" placeholder="商家姓名" />
		</view>
		<view v-if="tableName=='shangjia'" class="uni-form-item uni-column">
